...
const BRANCH_LABELS: TransferUiLabels = {
  ...
  moduleSubtitle: 'Quản lý yêu cầu chuyển hàng giữa các chi nhánh',
  createButton: 'Tạo yêu cầu chuyển hàng',
  createDialogTitle: 'Tạo yêu cầu chuyển hàng',
  createDialogDescription:
    'Chi nhánh chỉ được xuất từ chi nhánh của mình sang chi nhánh khác.',
  ...
  searchPlaceholder: 'Tìm theo chi nhánh, mã yêu cầu...',
  ...
  sameLocationError: 'Chi nhánh gửi và chi nhánh nhận không được trùng nhau',
  loadLocationsError: 'Không thể tải danh sách chi nhánh',
  loadProductsError: 'Không thể tải hàng tại chi nhánh nguồn',
  receiveTitle: 'Xác nhận nhận hàng chuyển',
